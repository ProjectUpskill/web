        ...
        <Modal show={show} onHide={handleClose} size="lg">
          ...
          <Modal.Body className={styles.constructionBox}>
            ...
            <img src={logo} alt="Project Upskill" height={60} width={160} />
                ...
                <p>                Have you considered joining our forums?

                    The more editors, artists, software engineers, marketing people, etc, we can get, the faster and better Project Upskill can become a reality!</p>
                </Row>
                </Col>
                </Row></Modal.Body>
          <Modal.Footer>
            ...
            <Button variant="primary" href="https://discourse.projectupskill.org" size="lg">
